...
<p>
  ...
  <a href="wiki(`Irc')">IRC</a> or shoot a mail to cp@bitrig.org.
</p>
...
')dnl
DONATE(`ARMv8 development board',`ARMv8 is the architecture of the future. Every ARM-based device to be
released will be based on it. To help port Bitrig, we would love to gain
access to a development board.
')
DONATE(`SSDs',`To help run our build and test machines we would like to supply those with
